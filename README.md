...
This branch supports PHPUnit 6.x. This version is only compatible with PHP 7.

The third supported line is 3.x, which supports PHPUnit 5.x. This version is only compatible with PHP 5.6 and PHP 7.
